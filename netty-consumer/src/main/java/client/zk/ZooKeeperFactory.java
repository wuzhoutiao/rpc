...
public class ZooKeeperFactory {
    ...
    public static CuratorFramework getClient(){
        if(client==null){
            ...
            client = CuratorFrameworkFactory.newClient("127.0.0.1:2181,127.0.0.1:2182,127.0.0.1:2183", retryPolicy); //使用刚才定义的重试机制，创建一个 ZooKeeper 客户端，并连接到这台 ZooKeeper 服务(127.0.0.1:2181只是表示Zookeeper服务运行在哪儿，不是节点路径)
            client.start();
        }
